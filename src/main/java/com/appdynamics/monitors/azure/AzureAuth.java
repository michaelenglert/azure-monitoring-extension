...
public class AzureAuth {
    public static AuthenticationResult getAzureAuth (String clientId, String clientSecret,String tenantId) throws MalformedURLException, ExecutionException, InterruptedException {
